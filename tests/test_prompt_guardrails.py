...
def test_review_prompt_requires_note_first_synthesis_and_profile_controls():
    ...
    for phrase in (
        ...
        "primary CPF/CEN is the principal analytical lens",
        "accompanying package evidence is detailed",
        "RRA and contextual evidence are thematic supporting lenses",
...
def test_diagnostic_map_prompt_describes_single_safe_schema_retry():
