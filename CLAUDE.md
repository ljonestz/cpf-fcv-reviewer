...
paragraph styles, left alignment, one-inch margins and no floating text boxes. The navy
running banner uses header paragraph shading and a teal border, with white text.
